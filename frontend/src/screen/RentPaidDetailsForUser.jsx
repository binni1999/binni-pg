...
import {
  useGetPdfPathsQuery,
  usePaidRentDetailsQuery,
} from "../slices/userApiSlice";
import Meta from "../components/Meta";

const RentPaidDetailsForUser = () => {
      ...
      <Row className="my-4">
        ...
        <Col>
          <button
            ...
            className="luffy-button"
          >
            <strong>Contact: {userInfo.mobileNumber}</strong>
          </button>
        </Col>
      </Row>
      <Row>
...
export default RentPaidDetailsForUser;
